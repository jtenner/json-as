(module
 ...
 (data (i32.const 256) "\0e\00\00\00\01\00\00\00\01\00\00\00\0e\00\00\00J\00N\00u\00m\00b\00e\00r")
 ...
 (func $start:assembly/__tests__/JNumber.spec~anonymous|0~anonymous|9 (; 95 ;) (type $FUNCSIG$v)
  ...
  call $node_modules/as-pect/assembly/internal/Expectation/expect<f64>
  local.tee $1
  f64.const 3141592599999999725608627e18
  call $node_modules/as-pect/assembly/internal/Expectation/Expectation<f64>#toBe
  local.get $0
  call $~lib/rt/pure/__release
  local.get $1
 ...
 (func $start (; 108 ;) (type $FUNCSIG$v)
  ...
  i32.const 0
  global.set $~lib/argc
  call $start:assembly/__tests__/JNumber.spec~anonymous|0
